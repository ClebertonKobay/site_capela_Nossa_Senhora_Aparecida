...
export function Header() {
  return (
    <header className="sticky top-3 z-40 mx-3 mt-3 rounded-2xl border-b-2 border-accent bg-white text-primary shadow-[0_10px_28px_-8px_rgba(212,165,55,0.5)] lg:mx-auto lg:max-w-4xl">
      <div className="flex items-center gap-4 px-4">
        <a href="#inicio" className="flex min-h-11 shrink-0 items-center text-base font-bold text-primary">
