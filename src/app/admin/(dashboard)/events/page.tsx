    ...
    <div>
      <div className="flex items-center justify-between">
        ...
        <Link
          ...
          className="flex min-h-11 items-center bg-accent px-4 py-2 text-base font-semibold text-primary"
        >
          Novo evento
        </Link>
      </div>
      ...
      {allEvents.length === 0 ? (
        ...
        <ul className="mt-4 flex flex-col gap-3">
          {allEvents.map((event) => (
            <li key={event.id} className="border-2 border-primary-light px-4 py-3">
              ...
              <div className="mt-2 flex items-center gap-4">
                <Link
                  ...
                  className="text-base font-semibold text-primary-light underline"
                >
                  Editar
                </Link>
